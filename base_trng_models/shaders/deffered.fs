...
void main()
{
    ...
    FragColor =vec4((0.4 +0.6 *  (res) )* texColor.xyz,1.0);//texColor;// LightDir.y*(0.3 +0.7*(shadow_res) *norm_l) * texColor;

    //FragColor =vec4(0.4 +0.6 *  (res) * vec3(1.0,1.0,1.0),1.0);//texColor;// LightDir.y*(0.3 +0.7*(shadow_res) *norm_l) * texColor;
