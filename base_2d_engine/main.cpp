...
/*
    ...
    if(is_fullscreen)
    {
        ...
        window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Microscope", monitor, nullptr);
    }
    else
    {
	    window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Microscope", nullptr, nullptr);
    }
    ...
    GlGameStateDungeon game_state_dungeon(m_shader_map,m_render_target_map,resources_atlas,width,height);
